...
header = {'authority': '3344mf.com',
          ...
          'cookie': '__cfduid=d55fb0b4b1b383825f866e208d0fbf63f1511522923',
          'upgrade-insecure-requests': '1',
          'user-agent': user_agent_list[random.choice(range(60))]}
...
for index in range(0,250,50):
    response=request.urlopen("http://api.douban.com/v2/movie/top250?start=%d&count=50"% index)
    data=response.read()
...
for mid in movie_ids:
    print(count,mid)
    try:
        # page = request.Request(url='http://api.douban.com/v2/movie/subject/%s'%mid, headers=header);
